...
for i in range(linha_inicial, linha_inicial + num_linhas):
    ...
    pyautogui.click(x=174, y=368)
    time.sleep(1.5)
    pyautogui.click(x=210, y=409)
    time.sleep(1.2)
    ...
    try:
        pyautogui.moveTo(x=109, y=393) # Posição inicial da seleção (x=109, y=315)<<<< antigo antes do aviso
